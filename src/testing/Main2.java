...
public class Main2 {
    ...
    public static void main(String[] args) {
        ...
        juego.iniciarJuego(rutaFichas, rutaAlphabet);
        ...
        while (!juego.isJuegoTerminado()) {
            for (Jugador jugador : jugadores) {
                Tuple<Map<String, Integer>, Integer> result = juego.realizarTurno(jugador.getNombre(), jugador.getRack(), jugador instanceof JugadorIA);
