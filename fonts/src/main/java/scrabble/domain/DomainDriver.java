...
public class DomainDriver {
    ...
    public static void initializeDefaultSettings() {
        String resourcesPath = "src/java/resources/diccionarios/";
    ...
    public static void manageRankingVer() throws IOException {
        ...
        while (!volver) {
            ...
            int espaciosTitulo = (89 - estrategiaFormateada.length() - 27) / 2; // 27 es la longitud de "RANKING DE JUGADORES ()"
            String espaciosIzquierda = " ".repeat(espaciosTitulo);
            // Asegurar que el espaciado a la derecha completa exactamente 78 caracteres
            int espaciosDerecha = 89 - espaciosTitulo - 27 - estrategiaFormateada.length() - 1; // -1 por el pipe al final
            ...
            output.append("+------------------------------------------------------------------------------------+\n");
            output.append("| Posición | Jugador             | Punt. Máxima | Punt. Media | Partidas | Victorias |\n");
            output.append("+----------+---------------------+--------------+-------------+----------+-----------+\n");
            ...
            for (String id : rankingOrdenado) {
                ...
                output.append(String.format("| %-8d | %-19s | %-12d | %-11.2f | %-8d | %-9d |\n", 
